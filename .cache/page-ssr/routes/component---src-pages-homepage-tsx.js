...
})(["position:fixed;z-index:97;right:20px;top:20px;display:grid;place-content:center;padding:15px;border-radius:100%;background:white;border:none;transition:0.5s ease-out;height:40px;width:40px;& > *{margin:auto;}&:hover{box-shadow:0 2px 3px 1px lightgrey;cursor:pointer;}"]);
...
/* harmony import */ var _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../../../context/ProjectModalContext */ "./src/context/ProjectModalContext.tsx");
...
const MobileMenu = ({
  ...
  const {
    projectModalState
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useContext)(_context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_7__["default"]);
...
const MobileMenuContainer = styled_components__WEBPACK_IMPORTED_MODULE_1__["default"].div.withConfig({
  ...
  isOpen
}) => isOpen ? 99 : -1, _particles_Theme__WEBPACK_IMPORTED_MODULE_0__["default"].color.mono, ({
  isOpen
}) => isOpen ? "100%" : "0%");
...
/* harmony import */ var _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../../../context/ProjectModalContext */ "./src/context/ProjectModalContext.tsx");
...
const ProjectDetail = () => {
  const {
    projectModalState,
    action
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_4__["default"]);
  console.log(projectModalState);
  ...
  if (projectModalState !== null) {
    ...
    return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_projectDetail_styled__WEBPACK_IMPORTED_MODULE_3__.ProjectDetailContainer, {
      ...
      onClick: () => action({
        type: _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_4__.CLOSE_MODAL,
        payload: {
          isOpen: false
        }
      })
...
})(["position:fixed;top:0;left:0;right:0;display:", ";box-sizing:border-box;height:100%;width:100%;background-color:", ";padding:20px 5%;color:white;z-index:99;padding-bottom:70px;animation-fill-mode:backwards !important;"], ({
  isOpen
...
/* harmony import */ var _react_icons_all_files_gr_GrInstagram__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! @react-icons/all-files/gr/GrInstagram */ "./node_modules/@react-icons/all-files/gr/GrInstagram.js");
/* harmony import */ var _react_icons_all_files_gr_GrLinkedin__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @react-icons/all-files/gr/GrLinkedin */ "./node_modules/@react-icons/all-files/gr/GrLinkedin.js");
/* harmony import */ var _react_icons_all_files_gr_GrGithub__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @react-icons/all-files/gr/GrGithub */ "./node_modules/@react-icons/all-files/gr/GrGithub.js");
...
/* harmony import */ var _assets_content_copyWrite_json__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../../../assets/content/copyWrite.json */ "./src/assets/content/copyWrite.json");
...
const Footer = ({}) => {
  ...
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_react_icons_all_files_gr_GrLinkedin__WEBPACK_IMPORTED_MODULE_8__.GrLinkedin, {
    color: _particles_Theme__WEBPACK_IMPORTED_MODULE_4__["default"].color.gold,
    fontSize: "1.7em"
  })), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_atoms_link_link_styled__WEBPACK_IMPORTED_MODULE_3__["default"], {
    to: "https://github.com/hatealgebra"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_react_icons_all_files_gr_GrGithub__WEBPACK_IMPORTED_MODULE_9__.GrGithub, {
    color: _particles_Theme__WEBPACK_IMPORTED_MODULE_4__["default"].color.gold,
    fontSize: "1.7em"
...
/* harmony import */ var _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../../../context/ProjectModalContext */ "./src/context/ProjectModalContext.tsx");
...
const ProjectPreview = ({
  ...
  const {
    projectModalState,
    action
  } = (0,react__WEBPACK_IMPORTED_MODULE_0__.useContext)(_context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_3__["default"]);

  const openModal = () => {
    action({
      type: _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_3__.OPEN_MODAL,
      payload: {
        heading,
        techStack,
        date,
  ...
  }, children), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(react_scroll_parallax__WEBPACK_IMPORTED_MODULE_2__.ParallaxBanner, {
...
})(["text-align:", ";margin:50px 0px;box-sizing:border-box;cursor:pointer;.project-preview{box-sizing:border-box;&_text{margin-top:20px;}&_img{width:100%;max-width:600px;margin-top:40px;}}@media ", "{display:grid;align-items:flex-start;grid-template-columns:auto 1fr;.project-preview{&_img{grid-row:1/10;grid-column:2/3;margin-top:20px;}}}"], props => props.orientation, _utils_helpers__WEBPACK_IMPORTED_MODULE_0__.DEVICE.laptop);
...
})(["z-index:97;position:fixed;top:0;left:0;right:0;display:flex;justify-content:space-between;width:100%;max-width:1200px;margin:auto;padding:15px 5%;color:white;mix-blend-mode:difference;"]);

/***/ }),

/***/ "./src/components/particles/ContextProviderComponent.tsx":
/*!***************************************************************!*\
  !*** ./src/components/particles/ContextProviderComponent.tsx ***!
  \***************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../context/ProjectModalContext */ "./src/context/ProjectModalContext.tsx");
...
const ContextProviderComponent = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_context_ProjectModalContext__WEBPACK_IMPORTED_MODULE_1__.ProjectModalProvider, null, children);
};

/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ContextProviderComponent);
...
/* harmony import */ var _particles_ContextProviderComponent__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../particles/ContextProviderComponent */ "./src/components/particles/ContextProviderComponent.tsx");
/* harmony import */ var _particles_Theme__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../particles/Theme */ "./src/components/particles/Theme.ts");
...
const PageContainer = styled_components__WEBPACK_IMPORTED_MODULE_9__["default"].main.withConfig({
...
const PageTemplate = ({
  ...
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_particles_ContextProviderComponent__WEBPACK_IMPORTED_MODULE_7__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(PageContainer, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_globalStyle__WEBPACK_IMPORTED_MODULE_1__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("title", null, "Pavel Vondra's site"), width && width >= _particles_Theme__WEBPACK_IMPORTED_MODULE_8__["default"].breakpoints.tablet ? /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_organisms_topBar_TopBar__WEBPACK_IMPORTED_MODULE_6__["default"], null) : /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement((react__WEBPACK_IMPORTED_MODULE_0___default().Fragment), null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_molecules_mobileMenu_MobileMenu__WEBPACK_IMPORTED_MODULE_4__["default"], {
    isOpen: isOpen,
...
/***/ "./src/context/ProjectModalContext.tsx":
/*!*********************************************!*\
  !*** ./src/context/ProjectModalContext.tsx ***!
  \*********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */   "ProjectModalContext": () => (/* binding */ ProjectModalContext),
/* harmony export */   "ProjectModalProvider": () => (/* binding */ ProjectModalProvider),
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/esm/defineProperty */ "./node_modules/@babel/runtime/helpers/esm/defineProperty.js");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
...
(function (EActionType) {
  EActionType["OPEN_MODAL"] = "OPEN_MODAL";
  EActionType["CLOSE_MODAL"] = "CLOSE_MODAL";
...
const ProjectModalContext = /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createContext({
  projectModalState: initialState,
  action: () => {}
});

const projectModalReducer = (projectModalState, action) => {
  switch (action.type) {
    ...
    case EActionType.CLOSE_MODAL:
      return _objectSpread(_objectSpread({}, projectModalState), {}, {
        isOpen: false
      });
      break;
...
const ProjectModalProvider = ({
  children
}) => {
  const {
    0: projectModalState,
    1: action
  } = (0,react__WEBPACK_IMPORTED_MODULE_1__.useReducer)(projectModalReducer, initialState);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(ProjectModalContext.Provider, {
    value: {
      projectModalState,
      action
    }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProjectModalContext);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _public_page_data_sq_d_1211668565_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../public/page-data/sq/d/1211668565.json */ "./public/page-data/sq/d/1211668565.json");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! react */ "react");
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
...
/* harmony import */ var _components_particles_Theme__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../components/particles/Theme */ "./src/components/particles/Theme.ts");
/* harmony import */ var _components_molecules_headingCode_HeadingCode__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../components/molecules/headingCode/HeadingCode */ "./src/components/molecules/headingCode/HeadingCode.tsx");
/* harmony import */ var _components_molecules_container_Container__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../components/molecules/container/Container */ "./src/components/molecules/container/Container.tsx");
/* harmony import */ var _react_icons_all_files_im_ImArrowLeft__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! @react-icons/all-files/im/ImArrowLeft */ "./node_modules/@react-icons/all-files/im/ImArrowLeft.js");
/* harmony import */ var _react_icons_all_files_fa_FaCode__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @react-icons/all-files/fa/FaCode */ "./node_modules/@react-icons/all-files/fa/FaCode.js");
...
/* harmony import */ var _components_atoms_link_link_styled__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../components/atoms/link/link.styled */ "./src/components/atoms/link/link.styled.tsx");
/* harmony import */ var _components_organisms_projectPreview_ProjectPreview__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../components/organisms/projectPreview/ProjectPreview */ "./src/components/organisms/projectPreview/ProjectPreview.tsx");
/* harmony import */ var _components_templates_Page_template__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../components/templates/Page.template */ "./src/components/templates/Page.template.tsx");
/* harmony import */ var _assets_content_labData_json__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../assets/content/labData.json */ "./src/assets/content/labData.json");
/* harmony import */ var _assets_content_copyWrite_json__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../assets/content/copyWrite.json */ "./src/assets/content/copyWrite.json");
/* harmony import */ var react_awesome_reveal__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! react-awesome-reveal */ "./node_modules/react-awesome-reveal/dist/react-awesome-reveal.esm.js");
/* harmony import */ var _utils_helpers__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../utils/helpers */ "./src/utils/helpers.ts");
/* harmony import */ var _utils_contants__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../utils/contants */ "./src/utils/contants.ts");
/* harmony import */ var react_scroll_parallax__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! react-scroll-parallax */ "./node_modules/react-scroll-parallax/dist/react-scroll-parallax.esm.js");
/* harmony import */ var _utils_hooks_useWindowSize__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../utils/hooks/useWindowSize */ "./src/utils/hooks/useWindowSize.ts");
/* harmony import */ var _components_molecules_projectDetail_ProjectDetail__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../components/molecules/projectDetail/ProjectDetail */ "./src/components/molecules/projectDetail/ProjectDetail.tsx");
...
const IndexPage = () => {
  ...
  const homepageContent = _assets_content_copyWrite_json__WEBPACK_IMPORTED_MODULE_9__.pages.homepage;
  const windowSize = (0,_utils_hooks_useWindowSize__WEBPACK_IMPORTED_MODULE_13__["default"])();
  const data = _public_page_data_sq_d_1211668565_json__WEBPACK_IMPORTED_MODULE_0__.data;
  const images = [(0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_16__.getImage)(data.foodMood.edges[0].node.childImageSharp), (0,gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_16__.getImage)(data.weatherApp.edges[0].node.childImageSharp)];
  (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(() => {
    window.addEventListener("scroll", () => window.pageYOffset > 4 ? setHeroScroll(true) : setHeroScroll(false));
  }, [heroScroll]);
  return /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_templates_Page_template__WEBPACK_IMPORTED_MODULE_7__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_projectDetail_ProjectDetail__WEBPACK_IMPORTED_MODULE_14__["default"], null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(HeroContainer, {
    scroll: heroScroll
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "hero_part hero_part--hidden"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    className: "hero_part"
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h1", null, "Wel ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), "come."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(HelloThereHero, {
    className: "hero_part--hidden"
  }, heroScroll && /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_awesome_reveal__WEBPACK_IMPORTED_MODULE_17__.Fade, {
    direction: "down",
    triggerOnce: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
    className: "hlthere_heading libre"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_react_icons_all_files_fa_FaCode__WEBPACK_IMPORTED_MODULE_18__.FaCode, {
    fontSize: "2.2rem"
  }), "Hello there"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h4", null, "This is my webpage, where I showcase", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    style: {
      color: "white"
    }
  }, "myself and work that is behind me. Enjoy!")))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(ScrollLabel, null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_react_icons_all_files_im_ImArrowLeft__WEBPACK_IMPORTED_MODULE_19__.ImArrowLeft, null), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", null, "Scroll"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_container_Container__WEBPACK_IMPORTED_MODULE_4__["default"], {
    grid: true
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_headingCode_HeadingCode__WEBPACK_IMPORTED_MODULE_3__["default"], null, "My self"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_scroll_parallax__WEBPACK_IMPORTED_MODULE_12__.ParallaxBanner, {
    layers: [{
      children: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_16__.StaticImage, {
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h4", null, "An", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
    className: "libre"
  }, " aspiring "), "front-end developer."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "Felt in love with web development. I love when nice things are functional and helpful. Trying to become good developer step by tep. Learning new things, meeting new people, apprehending new informations, till my brain(emoticon) can\u2019t go further.", " "), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, "In meantime I\u2019m cat dad that plays basketball in Germany. Also I\u2019m searching for new sneakers, enjoy car sims, listen to music or read Batman comics.")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_atoms_link_link_styled__WEBPACK_IMPORTED_MODULE_5__["default"], {
    to: _utils_contants__WEBPACK_IMPORTED_MODULE_11__.LINKS.about
  }, "What I can do")), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_container_Container__WEBPACK_IMPORTED_MODULE_4__["default"], {
    variant: "projects",
    background: "black"
  }, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_16__.StaticImage, {
  ...
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_headingCode_HeadingCode__WEBPACK_IMPORTED_MODULE_3__["default"], {
    right: true
  }, "work"), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h4", {
    className: "justify--right"
  }, "Just", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("span", {
    className: "libre"
  }, " some of "), "my projects."), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("div", {
    style: {
      display: "flex",
      flexDirection: "column"
    }
  }, _assets_content_labData_json__WEBPACK_IMPORTED_MODULE_8__.lab.map((data, index) => /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_organisms_projectPreview_ProjectPreview__WEBPACK_IMPORTED_MODULE_6__["default"], {
    key: data.name + index,
    heading: data.name,
    ...
    image: /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_16__.GatsbyImage, {
      image: images[index],
      alt: "Pancakes",
      style: {
        width: "100%",
  ...
  }, data.preview_text)), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_atoms_link_link_styled__WEBPACK_IMPORTED_MODULE_5__["default"], {
    style: {
      alignSelf: "center"
    },
    white: true,
    to: _utils_contants__WEBPACK_IMPORTED_MODULE_11__.LINKS.work
  }, "Show All"))), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_molecules_container_Container__WEBPACK_IMPORTED_MODULE_4__["default"], null, /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h2", null, homepageContent.sectionWMyPhoto.heading[0]), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(react_scroll_parallax__WEBPACK_IMPORTED_MODULE_12__.ParallaxBanner, {
    ...
    style: {
      aspectRatio: windowSize.width && windowSize.width >= _components_particles_Theme__WEBPACK_IMPORTED_MODULE_2__["default"].breakpoints.laptop ? "2.5/1" : "1.5/1"
    }
  }), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("h2", null, homepageContent.sectionWMyPhoto.heading[1], " ", /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("br", null), homepageContent.sectionWMyPhoto.heading[2]), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement("p", null, homepageContent.sectionWMyPhoto.text), /*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_1___default().createElement(_components_atoms_link_link_styled__WEBPACK_IMPORTED_MODULE_5__["default"], {
    to: _utils_contants__WEBPACK_IMPORTED_MODULE_11__.LINKS.about
  }, "More about me")));
};

const getGatsbyImages = "1408227031";
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage); // TODO merge homepage and index pages into the on
...
/***/ "./public/page-data/sq/d/1211668565.json":
/*!***********************************************!*\
  !*** ./public/page-data/sq/d/1211668565.json ***!
  \***********************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"data":{"weatherApp":{"edges":[{"node":{"absolutePath":"/Users/pavelvondra/Work/Coding/Portfolio/my-website/src/assets/images/lab/weatherApp/weather-preview.jpg","sourceInstanceName":"lab","relativeDirectory":"weatherApp","childImageSharp":{"gatsbyImageData":{"layout":"constrained","backgroundColor":"#e8e8e8","images":{"fallback":{"src":"/static/9a7c70dfcc3853759da41382ee95012e/c2011/weather-preview.jpg","srcSet":"/static/9a7c70dfcc3853759da41382ee95012e/45c98/weather-preview.jpg 480w,\\n/static/9a7c70dfcc3853759da41382ee95012e/579d6/weather-preview.jpg 960w,\\n/static/9a7c70dfcc3853759da41382ee95012e/c2011/weather-preview.jpg 1920w","sizes":"(min-width: 1920px) 1920px, 100vw"},"sources":[{"srcSet":"/static/9a7c70dfcc3853759da41382ee95012e/2ad17/weather-preview.webp 480w,\\n/static/9a7c70dfcc3853759da41382ee95012e/60d3b/weather-preview.webp 960w,\\n/static/9a7c70dfcc3853759da41382ee95012e/854bb/weather-preview.webp 1920w","type":"image/webp","sizes":"(min-width: 1920px) 1920px, 100vw"}]},"width":1920,"height":2469}}}}]},"foodMood":{"edges":[{"node":{"absolutePath":"/Users/pavelvondra/Work/Coding/Portfolio/my-website/src/assets/images/lab/foodMood/pancakes.jpg","sourceInstanceName":"lab","relativeDirectory":"foodMood","childImageSharp":{"gatsbyImageData":{"layout":"constrained","backgroundColor":"#383848","images":{"fallback":{"src":"/static/d940cbaae915aeb77021b65e38822c25/fea07/pancakes.jpg","srcSet":"/static/d940cbaae915aeb77021b65e38822c25/4fa91/pancakes.jpg 480w,\\n/static/d940cbaae915aeb77021b65e38822c25/adc6a/pancakes.jpg 960w,\\n/static/d940cbaae915aeb77021b65e38822c25/fea07/pancakes.jpg 1920w","sizes":"(min-width: 1920px) 1920px, 100vw"},"sources":[{"srcSet":"/static/d940cbaae915aeb77021b65e38822c25/087eb/pancakes.webp 480w,\\n/static/d940cbaae915aeb77021b65e38822c25/67b4c/pancakes.webp 960w,\\n/static/d940cbaae915aeb77021b65e38822c25/057a1/pancakes.webp 1920w","type":"image/webp","sizes":"(min-width: 1920px) 1920px, 100vw"}]},"width":1920,"height":2320}}}}]}}}');

/***/ }),

/***/ "./src/assets/content/copyWrite.json":
/*!*******************************************!*\
  !*** ./src/assets/content/copyWrite.json ***!
  \*******************************************/
/***/ ((module) => {
...
"use strict";
module.exports = JSON.parse('{"pages":{"homepage":{"sectionWMyPhoto":{"heading":["Bball,","nolan,","race sims"],"text":"Little about me. I do like to play basketball, so I can eat more cookies and oreo. Whatever movie that Christopher Nolan makes, it\'s must see. And if I\'m not doing any of the two activies that I\'ve mention before I am probably channeling my inner Sir Lewis Hamilton on race simulators."}},"work":{"heading":"MY WORK","labText":"Showcase of my work in my freetime. Either I\'m learning new things, have new ideas or I want to showcase some of my skill. If you find anything interesting or bugs, please don\'t hesitate and contact me. Thank you."},"about":{"aboutMe":{"introduction":[{"heading":"Software engineer","text":["I’m currently working as fresh software engineer in  maintenance and support for big coporation that makes banking solutions across the world.","Learning front end development by myself almost 2 years. I have experience in industry as IT-Administrator. Currently looking for extra part-time job, in best case scenario full remote."]},{"heading":"My Aim","text":["… is to write quality code that is functional, testable and sustainable. I’m on the start to become good developer and I’m open to new things and opportunities that can benefit me and others along the way.","Also I make some basic designing/prototyping as something that comes handy, because on some of the projects I’ve done everything by myself.  Check down below what tech stack I use and other skills."]}]}}},"menu":{"1st":"Currently Software <br /> Engineer at Diebold Nixdorf","2nd":"Based in Pilsen <br /> Czech republic"},"footer":{"heading":["Reach","me out"],"headingText":"You can contact me either via social links down below or write me eail via form. Looking forward to hear from you","email":"HELLO@PAVEL-VONDRA.COM"}}');
